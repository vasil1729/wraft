defmodule WraftDocWeb.Api.V1.UserController do
  ...
  def signin(conn, params) do
    ...
    # Sentinel: Check for empty password early to avoid enumeration on missing input
    if password in ["", nil] do
      {:error, :no_data}
    else
      # Sentinel: Mitigate user enumeration timing attack by normalizing failure path
      user_lookup_result =
