defmodule WraftDocWeb.Api.V1.UserController do
  ...
  def signin(conn, params) do
    ...
    if email in ["", nil] or password in ["", nil] do
      {:error, :no_data}
    else
      # [Security] Mitigate timing attacks by separating bcrypt validation path,
      # and mapping not found errors to generic :invalid to prevent user enumeration.
      user_result =
