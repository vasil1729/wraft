defmodule WraftDocWeb.Api.V1.UserController do
  ...
  def signin(conn, params) do
    # 🛡️ Sentinel: Mitigate timing attacks and user enumeration by always performing bcrypt hash
    user_lookup =
      case Account.find(params["email"]) do
        ...
        _ ->
          ...
          # Map all lookup errors to :invalid so FallbackController handles it generically
          {:error, :invalid}
      end
