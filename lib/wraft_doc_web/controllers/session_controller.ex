defmodule WraftDocWeb.SessionController do
  ...
  def create(conn, %{"session" => params}) do
    ...
    if user do
      # Mitigate timing attacks by verifying password before checking deactivated status
      ...
      # Mitigate timing attacks by simulating password hash time for non-existent users
