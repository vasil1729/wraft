defmodule WraftDocWeb.SessionController do
  ...
  def create(conn, %{"session" => params}) do
    ...
    # 🛡️ Sentinel: Mitigate timing attacks by forcing Bcrypt.no_user_verify() on invalid users
    # Verify password FIRST before checking is_deactivated to prevent status enumeration
    if user do
